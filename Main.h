...
public:
	...
	//Set MovementStatus at running speed
	...
	//Base turn rates to scale turning function of camera
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Camera")
	float BaseTurnRate;

	//Base lookup rates to scale turning function of camera
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Camera")
...
public:	
	...
	//Called for forward or backwards motion
	void MoveForward(float Value);

	//Called for left or right motion
