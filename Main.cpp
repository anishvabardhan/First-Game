...
AMain::AMain()
{
	...
	//Set size fro collision capsule
	GetCapsuleComponent()->SetCapsuleSize(34.f, 88.f);

	//Create Follow Camera
	FollowCamera = CreateDefaultSubobject<UCameraComponent>(TEXT("FollowCamera"));
	FollowCamera->SetupAttachment(CameraBoom, USpringArmComponent::SocketName);
	FollowCamera->bUsePawnControlRotation = false;//Attach the Camera to the end of Boom and let the Boom adjust to match the controller orientation

	//Set our turn rates for input
	BaseTurnRate = 65.f;
	BaseLookUpRate = 65.f;

	//Only camera rotates when the controller rotates not the character
...
void AMain::ShowPickupLocations()
{
	...
	{
		UKismetSystemLibrary::DrawDebugSphere(this, PickupLocations[i], 25.f, 24, FLinearColor::Green, 10.f, 0.5f);
	}
}
...
void AMain::SwitchLevels(FName LevelName)
{
